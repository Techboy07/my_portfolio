...
<div ref={paragraphs}>
  <Paragraph paragraphText={"The web is changing rapidly and with it the possibilities to implement websites and web applications. Following the modern JAMSTACK-philosophy and using tools like Static Site Generators, Headless CMS and a serverless architecture make it possible to create modern, state of the art web experiences."} color={"mb-3 lg:mb-8"}/>
  ...
  <Paragraph paragraphText={"And that's what it's all about in the end: Creating the best possible experience for your users."} color={"mb-3 lg:mb-8"}/>
  ...
  <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 w-full items-center pb-24 justify-evenly">
    ...
    {
      technologies.map((tech,idx)=><div key={idx} className="w-36 flex items-center lg:w-52">
<img src={tech} alt="tech image" className="w-full"/>
  </div>)
    }
  </div>
